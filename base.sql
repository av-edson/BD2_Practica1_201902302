create database BD2 collate SQL_Latin1_General_CP1_CI_AS
go

use BD2
go

grant connect on database :: BD2 to dbo
go

grant view any column encryption key definition, view any column master key definition on database :: BD2 to [public]
go
...
create index IX_CourseTutor_CourseCodCourse
    on practica1.CourseTutor (CourseCodCourse)
go

create index IX_CourseTutor_TutorId
    on practica1.CourseTutor (TutorId)
go
...
create index IX_Notification_UserId
    on practica1.Notification (UserId)
go
...
create index IX_ProfileStudent_UserId
    on practica1.ProfileStudent (UserId)
go
...
create index IX_TutorProfile_UserId
    on practica1.TutorProfile (UserId)
go
...
create index IX_UsuarioRole_RoleId
    on practica1.UsuarioRole (RoleId)
go

create index IX_UsuarioRole_UserId
    on practica1.UsuarioRole (UserId)
go
